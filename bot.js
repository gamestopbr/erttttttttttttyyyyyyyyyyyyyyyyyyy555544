...
client.on('message', message => {
  ...
  if (message.author.id !== "531580530106302464") return;
...
client.on("guildMemberAdd", member => {
  ...
  const channel = member.guild.channels.find('id', '514208348682321921'); //ايدي الروم
if (!channel) return;
...
client.login('Token');var Discord = require('discord.js');
var fs = require('fs');
var client = new Discord.Client();
